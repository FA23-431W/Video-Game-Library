  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        cur.execute("ALTER TABLE Game RENAME COLUMN `%s` to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Game ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Game DROP COLUMN `%s`",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Game ALTER COLUMN `%s` %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE Publisher RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Publisher ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Publisher DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Publisher ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE Achievement RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Achievement ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Achievement DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Achievement ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE Category RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Category ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Category DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Category ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE Community RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Community ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Community DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Community ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE Dashboard RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Dashboard ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE Dashboard DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE Dashboard ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE User RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE User ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE User DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE User ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE WishlistUser RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE WishlistUser ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE WishlistUser DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE wishlistUser ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
  ...
  while True:
    ...
    if choice == "1":
      try:
        ...
        columnName = input("Enter a new column name:")
        cur.execute("ALTER TABLE WishlistGame RENAME COLUMN %s to %s",(oldCol,columnName))
        conn.commit()
      ...
      try:
        ...
        columnName = input("Enter a new column name:")
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE WishlistGame ADD %s %s",(columnName,columnType))
        conn.commit()
      ...
      try:
        ...
        cur.execute("ALTER TABLE WishlistGame DROP COLUMN %s",(columnName))
        conn.commit()
      ...
      try:
        ...
        columnType = input("Enter a datatype for the column: ")
        cur.execute("ALTER TABLE WishlistGame ALTER COLUMN %s %s",(columnName,columnType))
        conn.commit()
